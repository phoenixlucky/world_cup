...
export function ScheduleView() {
  ...
  const koTeamIds = useMemo(() => {
    ...
    const r16Topology: [string, string][] = [
      [r32Winner('r32-0')!, r32Winner('r32-2')!],  // Match 90: Canada vs Morocco
      [r32Winner('r32-1')!, r32Winner('r32-4')!],  // Match 89: Paraguay vs France
      [r32Winner('r32-3')!, r32Winner('r32-5')!],  // Match 91: Brazil vs Norway
              ...
              {matches.map(m => {
                ...
                if (past && storedScore && home && away) {
                  ...
                  if (isKnockout) {
                    ...
                    scoreContent = (
                      <div className="flex flex-col items-center">
                        <span className={`text-xs font-mono ${homeWon ? 'text-green-400' : 'text-orange-400'}`}>
                          {rH}-{rA}
